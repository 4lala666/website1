...
const reviews = [
  {
    ...
    date: '15 января 2025',
    rating: 5,
    text: 'Огромная благодарность мастерам M-Granite. Памятник изготовили быстро и очень качественно. Гравировка портрета получилась точь-в-точь. Рекомендую всем.',
  },
  {
    name: 'Сергей М.',
    date: '3 декабря 2024',
